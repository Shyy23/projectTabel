...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2024 at 11:44 PM
...
(30, '', 'testing', 'L', 17, 'testt', '$2y$10$TAQ3YZVrUHvNCcIKvKNIZuKYdpNu012WvQwg64ii3l8B5ZyuFQqRW');
...
(14, 7, 2, 22, 7, '06:55:00', '09:53:00', 'tidak aktif');
...
(54, 'testtt', 'testtt', 'L', 'test', 2, 'testtt', '$2y$10$nRkdbwhevV0q3sXco9LfbOOZqqUpjQY5k.MqfLx35rAM.3uX7U/C.');
...
--
ALTER TABLE `absen`
  MODIFY `id_absen` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `guru`
--
ALTER TABLE `guru`
  MODIFY `id_guru` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `hari`
--
ALTER TABLE `hari`
  MODIFY `id_hari` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `siswa`
  MODIFY `id_siswa` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
